...
public class Initialiser implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        Blog blog1=new Blog(author1,"The new way of writing for IRB-composed length scale parts is a hybrid way of incorporating both uniformity of output and the more general structure used in the Adler-Astrich (A-A) and LAB volumes in ARC ; these sections will be increased in resolution.");
        ...
        Blog blog4=new Blog(author3,"When human employees ask it to understand what they're saying, they quickly become alarmed when their colleagues don't know what they're trying to say, something many employers call 'computer illiteracy'");
